...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('𝗦𝗮𝗮𝗱 𝗞𝗶𝗻𝗴 𝗬𝗧', {
        font: 'Standard',
    ...
    console.log(chalk.green('   ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ тɛℓɛɢяαм вσт: Active') : chalk.red('❌𝗦𝗮𝗮𝗱 𝗞𝗶𝗻𝗴 𝗬𝗧 тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ system is ready and running!\n'));
    }
