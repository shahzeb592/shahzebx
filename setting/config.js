...
global.owner = "923111361039" //owner number
global.footer = "⇝ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ⇝︎" //footer section
...
global.BOT_NAME = "ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ"
global.bankowner = "ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ"
global.creatorName = "ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ︎"
global.ownernumber = '923111361039'  //creator number
global.location = "Pakistan, sindh, Ghotki"
global.prefa = ['','!','.','#','&']
...
global.dev = "923111361039"
global.creatorName = "ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ"
global.footer = "ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ" //footer section
global.link = "https://whatsapp.com/channel/0029VbBt47G9hXF6S1MJMB1z"
global.autobio = true//auto update bio
global.botName = "💕⃝🕊️ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ 💕⃝🕊️"
global.version = "V2"
global.botname = "💕⃝🕊️ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ 💕⃝🕊️"
global.author = "༒︎ ՏᎻᎪᎻᏃᎬᏴ ༒︎"
global.themeemoji = '🤞'
...
global.author = "༒︎ ՏᎻᎪᎻᏃᎬᏴ ༒︎"
global.creator = "923111361039@s.whatsapp.net"
global.ownername = 'ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ︎' 
global.onlyowner = `☠️ 𝙎𝙤𝙧𝙧𝙮, 𝙏𝙝𝙞𝙨 𝙁𝙚𝙖𝙩𝙪𝙧𝙚 𝙄𝙨 𝙍𝙚𝙨𝙩𝙧𝙞𝙘𝙩𝙚𝙙 𝙏𝙤 𝙊𝙬𝙣𝙚𝙧𝙨 𝙊𝙣𝙡𝙮.  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *ՏᎻᎪᎻᏃᎬᏴ* 𝙩𝙤 𝙜𝙖𝙞𝙣 𝙤𝙬𝙣𝙚𝙧 𝙥𝙧𝙞𝙫𝙞𝙡𝙚𝙜𝙚𝙨.  
🕳️ 𝙄𝙡𝙡𝙚𝙜𝙖𝙡 𝙖𝙘𝙘𝙚𝙨𝙨 𝙬𝙞𝙡𝙡 𝙗𝙚 𝙘𝙡𝙚𝙖𝙣𝙨𝙚𝙙 𝙗𝙮 𝙩𝙝𝙚 𝑻𝒂𝒍𝒉𝒂.`
  // reply 
global.database = `☠️ 𝙏𝙤 𝙗𝙚 𝙖𝙙𝙙𝙚𝙙 𝙩𝙤 𝙩𝙝𝙚 𝘿𝘼𝙏𝘼𝘽𝘼𝙎𝙀 𝘽𝘼𝙎𝙀...  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *ՏᎻᎪᎻᏃᎬᏴ* — 𝙊𝙧 𝙗𝙚 𝙚𝙧𝙖𝙨𝙚𝙙 𝙗𝙮 𝙙𝙚𝙛𝙖𝙪𝙡𝙩.  🔗 *No entry without approval.*`
  global.mess = {
wait: "```☠️ WAIT FOR  ☠︎︎ 𝗦𝗮𝗮𝗱 𝗞𝗶𝗻𝗴 𝗠𝗗 ☠︎︎😈 ⚡ *Darkness intensifies...*  💀 *Brace yourself — The SAAD KING YT is rising.*```",
   success: "✔️ 𝗦𝗨𝗖𝗖𝗘𝗦𝗦 𝗕𝗬 👑 ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ 👑`  🔥 *Mission complete. The Void accepts your command.*",
   on: "`✔️👑 ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ 👑 𝗔𝗖𝗧𝗜𝗩𝗘 ⚔️`  🔥 *The SAAD KING is unleashed. Power running at full force.*  🕳️ *Enter if you dare.*", 
   ...
   off: "`❌ 👑 ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ︎︎👑 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗢𝗙𝗙 ⚰️`  🕳️ *The ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ has gone dark. All systems offline.*  ⚡ *Recharge and prepare for the next awakening.*",
   query: {
...
private: "Sorry bro, This Feature Can Only Be Used In Private Chats",
       owner: "Sorry bro, This Feature Can Only Be Used by 👑 ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ 👑 brr😋",
       ...
       premium: "This feature is specifically for my owner 👑ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ👑 🤤🫡",
   }
}

global.onlyowner = `\`[ 🤞 ] ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ \` \n*
...
global.database = `\`[ 👑 ] ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ 😙 \` \n*

        🚫 𝔸ℂℂ𝔼𝕊𝕊 𝔻𝔼ℕ𝕀𝔼𝔻 🚫

❌ *𝗦𝗢𝗥𝗥𝗬, 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 𝗜𝗦 𝗙𝗢𝗥𝗕𝗜𝗗𝗗𝗘𝗡 𝗙𝗢𝗥 𝗬𝗢𝗨!* ❌

💀 *𝗢𝗡𝗟𝗬 ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ 𝗠𝗘𝗠𝗕𝗘𝗥𝗦 𝗜𝗡 𝗢𝗨𝗥 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘 𝗛𝗢𝗟𝗗 𝗧𝗛𝗘 𝗞𝗘𝗬 𝗧𝗢 𝗔𝗖𝗖𝗘𝗦𝗦.* 😈

𝕮𝖔𝖓𝖙𝖆𝖈𝖙 𝕺𝖚𝖗 𝕺𝖋𝖋𝖎𝖈𝖎𝖆𝖑𝖘 𝕭𝖊𝖋𝖔𝖗𝖊 𝖞𝖔𝖚 𝖋𝖆𝖑𝖑:

🔥 𝖂𝖆: wa.me/923111361039
🕷️ 𝖙𝖌: t.me/Shahzebinfozone
💀 𝖜𝖆 𝖈𝖍𝖆𝖓𝖓𝖊𝖑: https://whatsapp.com/channel/0029VbBt47G9hXF6S1MJMB1z

𝕋𝕙𝕒𝕟𝕜𝕤 𝕗𝕠𝕣 𝕌𝕤𝕚𝕟𝕘  ꨄ ՏᎻᎪᎻᏃᎬᏴ ᎷᎠ ᏴϴͲ ꨄ︎︎`
